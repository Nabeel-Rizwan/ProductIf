...
import { View, Text, TextInput, Linking, Button, ActivityIndicator, StyleSheet, ScrollView, Image, Dimensions } from 'react-native';
...
const TopCompaniesChart = () => {
  ...
  const fetchTopCompanies = async () => {
    ...
    try {
      const response = await fetch(
        `http://api.adzuna.com/v1/api/jobs/de/top_companies?app_id=${API_ID}&app_key=${API_KEY}&what=${job}&content-type=application/json`
      );
  ...
  return (
    ...
    <Text style={styles.Title}>Top 5 companies hiring a talent in Germany, <Text style={styles.blue}>Get Insights</Text></Text>
