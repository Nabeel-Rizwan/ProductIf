...
const TopCompaniesChart = () => {
  ...
  const fetchTopCompanies = async () => {
    ...
    try {
      const response = await fetch(
        `http://api.adzuna.com/v1/api/jobs/us/top_companies?app_id=${API_ID}&app_key=${API_KEY}&what=${job}&content-type=application/json`
      );
  ...
  return (
    ...
    <Text style={styles.Title}>Top 5 companies hiring a talent in the US, <Text style={styles.blue}>Get Insights</Text></Text>
