...
import { View, Text, Image, FlatList, TextInput, ScrollView, StyleSheet, ActivityIndicator, TouchableOpacity, Linking, Modal, Button, SafeAreaView } from 'react-native';
...
const JobList = () => {
  ...
  const fetchJobs = async (isLoadMore = false) => {
    try {
      ...
      const response = await axios.get(`http://api.adzuna.com/v1/api/jobs/us/search/${page}`, {
        params: {
          app_id: API_ID,
          app_key: API_KEY,
          results_per_page: 20,
    ...
    <SafeAreaView style={styles.container}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          <Text onPress={API_Redirect} style={styles.LogoText}>Jobs by</Text>  
